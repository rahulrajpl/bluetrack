...
app.layout = html.Div(
    ...
    html.Div(
        className="app-header",
        children=[
            html.P('Stealthy Attack Detection in the Satellite hack', className="app-header--sub-head")
        ],
    ),

    html.Div(children=[
            html.Span('Anomaly detection using PASAD Technique', className="app-sub-sub-header")
        ],
        className="app-header",),
